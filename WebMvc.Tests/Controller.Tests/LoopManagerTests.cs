...
namespace WebMvc.Tests.Controller.Tests
{
    public class LoopManagerControllerTests
    {
        ...
        [Fact]
        public void UpdateRoutesInLoop_Get()
        {
            RoutesInLoopUpdateModel routeEditorModel = RoutesInLoopUpdateModel.FromLoop(
        ...
        [Fact]
        public void AddRouteToLoop_Get()
        {
        ...
        [Fact]
        public async void AddRouteToLoop_ModelError()
        {
        ...
        [Fact]
        public async void AddRouteToLoop_NullRoute()
        {
        ...
        [Fact]
        public async void AddRouteToLoop_Post()
        {
